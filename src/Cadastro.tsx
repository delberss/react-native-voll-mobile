import { Box, Button, Checkbox, FormControl, Image, Input, Link, ScrollView, Text, VStack} from 'native-base';
...
export default function Cadastro() {
  ...
  return (
    <ScrollView flex={1} p={5}>
      ...
      {
        numSecao > 0 && (
          <Botao bgColor="gray.400" onPress={() => voltarSecao()}>Voltar</Botao>
        )
      }
